...
private:
	struct special_evt {
		struct s {
			...
			static inline constexpr std::size_t event_id{4};
			static inline constexpr std::size_t tdb_1{16};
			static inline constexpr std::size_t n_additional_headers{8};
			...
			// other headers
			static inline constexpr std::size_t additional_header_type{8};
			static inline constexpr std::size_t additional_header_data{56};
		};
		...
		struct start_event_data {
			static inline constexpr event_id_type event_id{event_id_type::start};
			static inline constexpr std::size_t n_additional_headers{3};
			struct s {
				static inline constexpr std::size_t tbd_1{24};
				static inline constexpr std::size_t decimation_factor_log2{5};
				static inline constexpr std::size_t n_traces{2};
				static inline constexpr std::size_t acq_width{25};
				static inline constexpr std::size_t tbd_2{24};
				static inline constexpr std::size_t ch_mask_31_0{32};
				static inline constexpr std::size_t tbd_3{24};
				static inline constexpr std::size_t ch_mask_63_32{32};
			};
		...
		struct stop_event_data {
			static inline constexpr event_id_type event_id{event_id_type::stop};
			static inline constexpr std::size_t n_additional_headers{2};
			struct s {
				static inline constexpr std::size_t tbd_1{8};
				static inline constexpr std::size_t evt_time_tag{48};
				static inline constexpr std::size_t tbd_2{24};
				static inline constexpr std::size_t dead_time{32};
			};
			// - tbd_1 not saved into event
		...
		std::variant<std::monostate, start_event_data, stop_event_data> _event_data;
	};
