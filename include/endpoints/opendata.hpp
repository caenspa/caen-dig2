...
*
*	\file		opendata.hpp
*	\brief		OpenData endpoint
*	\author		Giovanni Cerretani, Matteo Fusco
*
******************************************************************************/

#ifndef CAEN_INCLUDE_ENDPOINTS_OPENDATA_HPP_
#define CAEN_INCLUDE_ENDPOINTS_OPENDATA_HPP_
...
struct opendata final : public hw_endpoint {
	...
	opendata(client& client, handle::internal_handle_t endpoint_handle);
	~opendata();
...
NLOHMANN_JSON_SERIALIZE_ENUM(opendata::names, {
	{ opendata::names::UNKNOWN, 	nullptr		},
	{ opendata::names::DATA, 		"DATA"s		},
	{ opendata::names::SIZE, 		"SIZE"s		},
})
...
#endif /* CAEN_INCLUDE_ENDPOINTS_OPENDATA_HPP_ */
